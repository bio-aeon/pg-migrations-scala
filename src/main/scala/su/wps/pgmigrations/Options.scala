...
/**
  ...
  */
sealed trait SchemaPrivilege extends Privilege
...
/**
  ...
  */
sealed trait GrantPrivilegeType extends Privilege
...
object CharacterSet {
  ...
  /**
    ...
    */
  def apply(name: CharacterSetName, collation: String): CharacterSet =
...
/**
  ...
  * a character set.  If the collation is unspecified then the
  ...
  */
case class CharacterSet(name: CharacterSetName, collationOpt: Option[String]) extends ColumnOption {
  ...
  /**
    ...
    * @param collation the name of the collation
    */
  def this(name: CharacterSetName, collation: String) {
...
/**
  ...
  */
case class Limit(expr: String) extends ColumnOption {
  try {
...
/**
  ...
  */
case class Name(name: String) extends CheckOption with ForeignKeyOption with IndexOption {
  if (name eq null) {
...
/**
  ...
  */
case class Check(expr: String) extends ColumnOption

/**
  * Specify a named check constraint on a column.
  */
case class NamedCheck(name: String, expr: String) extends ColumnOption
...
/**
  ...
  */
case object Nullable extends ColumnOption

/**
  * Specify the action that occurs when a value referenced in a foreign
  * key constraint is deleted.
  */
case class OnDelete(action: ForeignKeyConstraintAction) extends ForeignKeyOption

/**
  * Specify the action that occurs when a value referenced in a foreign
  * key constraint is updated.
  */
case class OnUpdate(action: ForeignKeyConstraintAction) extends ForeignKeyOption

/**
  * Specify the precision for a DECIMAL column.
  */
case class Precision(value: Int) extends ColumnOption {
  if (value < 1) {
...
/**
  ...
  */
case class Scale(value: Int) extends ColumnOption {
  if (value < 0) {
...
/**
  ...
  * are unique.
  */
case object Unique extends ColumnOption with IndexOption
...
/**
  ...
  * the column.
  *
  * This replaces the SMALLINT data type with
  ...
  * greater.
  */
case object AutoIncrement extends ColumnOption

/**
  * Specify that the column is unsigned.
  */
case object Unsigned extends ColumnOption
...
/**
  ...
  */
case object AllPrivileges extends GrantPrivilegeType with SchemaPrivilege

/**
  * Maps to GRANT DELETE.
  */
case object DeletePrivilege extends GrantPrivilegeType

/**
  * Maps to GRANT INSERT.
  */
case object InsertPrivilege extends GrantPrivilegeType

/**
  * Maps to GRANT TRIGGER.
  */
case object TriggerPrivilege extends GrantPrivilegeType
...
/**
  ...
  */
sealed abstract class PrivilegeWithColumns extends GrantPrivilegeType {
...
/**
  ...
  */
case class ReferencesPrivilege(override val columns: Seq[String]) extends PrivilegeWithColumns

/**
  * Maps to GRANT SELECT.
  */
case class SelectPrivilege(override val columns: Seq[String]) extends PrivilegeWithColumns

/**
  * Maps to GRANT UPDATE.
  */
case class UpdatePrivilege(override val columns: Seq[String]) extends PrivilegeWithColumns

// These next three are here as case objects to allow
// a no-parameters form in user code
case object ReferencesPrivilege extends GrantPrivilegeType

case object SelectPrivilege extends GrantPrivilegeType

case object UpdatePrivilege extends GrantPrivilegeType

/**
  * Maps to GRANT USAGE.
  */
case object UsagePrivilege extends SchemaPrivilege
